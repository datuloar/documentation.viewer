...
namespace datuloar.documentation.Config
{
    public class DocumentationEditorWindowConfig : ScriptableObject
    {
        ...
        [field: SerializeField] public Vector2 WindowMaxSize { get; private set; } = new Vector2(1920, 1080);
        [field: SerializeField] public float DocumentationTextHeight { get; private set; } = 65f;
    }
}
